...
import { getProducts } from "./galleryOperations";
...
export function AddGallery() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (result.success) {
        setMessage("Success", "Gallery image Added Successfully!");
        setLoading(false);
        router.push("/gallery");
      }
    }
  ...
  <div className="flex flex-col gap-6">
    ...
    <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-gray-200 pb-4">
      <h1 className="text-xl md:text-2xl font-semibold flex items-center gap-2 text-gray-800">
        <ChartBarStacked size={30} /> <span>Gallery / Add</span>
      </h1>
...
>
        ...
        <div className="pt-2">
          ...
          >
            {!loading ? "Add Gallery Image" : "Adding..."}
          </Button>
        </div>
      </form>
    </Form>
